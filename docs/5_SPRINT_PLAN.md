...
| **SP09-05** | Kiểm Thử Tích Hợp Luồng Streaming & DoD | - Kiểm thử tích hợp toàn diện HTTP Range 206, Probe 2-byte Safari, Static Assets, Retention Worker và Swagger UI | `services/gateway-core/tests/integration_streaming_test.go` | 0.4 ngày | ⚪ Chờ thực hiện |
